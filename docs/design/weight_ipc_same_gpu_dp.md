...
- [x] Two-process GPU smoke (`examples/weight_ipc/two_process_smoke.py`); cover non-zero offset
...
**Phase 3 verdict:** G2 **pass**. DP4 shared raises peak QPS; matched-load TTFC advantage vs DP3 was **not** confirmed here—keep weight IPC enabled for VRAM/DP4@100k, treat TTFC as host-specific.
